...
The player can do certain tricks on the skateboard to show off their skills
...
### QB:
4. Add the item to your `[qb]/qb-core/shared/items.lua`:
```lua
...
```
4. Add the images to your inventory eg. `[qb]/qb-inventory/html/images`

### OX:
4. Add the item to your `[ox]/ox_inventory/data/items.lua`:
```lua
    ["skateboard_01"] = {
...
- When placing the board, the model is detected based on that table
- Done
```
